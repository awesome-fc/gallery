        ...
        client.get(item).then(function (val) {
            ...
            jimp.read(val.content, function (err, image) {
                ...
                new Promise(function (resolve, reject) {
                    image.scaleToFit(1200, 750).write(tmpFullsFile, function (err) {
                        if (err) {
                            console.error('Failed to write image into fulls locally');
                    ...
                    return new Promise(function (resolve, reject) {
                        image.resize(360, 225).write(tmpThumbFile, function (err) {
                            if (err) {
                                console.error('Failed to write image into thumbs locally');
